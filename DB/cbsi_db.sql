...
--
-- Host: localhost
-- Generation Time: Mar 14, 2019 at 01:36 AM
...
(101008, 'user@gmail.com', '$2y$10$X7KUdegRapkxYHRIegXpUOBEjK9GvAX9ZGO9n3g3Ry69KIkwhp8lO', 'user', 'user', 'Active');
...
--
ALTER TABLE `user_details`
  MODIFY `user_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101009;
COMMIT;
