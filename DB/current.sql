...
--
-- Host: localhost
-- Generation Time: Apr 10, 2019 at 10:39 PM
...
(11, 'admin@gmail.com', '$2y$10$sMVh.x6QWJNzjU9/9PAU2.WzGViZtAWO53Jm3Wm3Nf6S/PEeSxbNC', 'Admin', 'administrator', 'master', 'Active', NULL),
(101008, 'user@gmail.com', '$2y$10$aBM18Xc8lFd.wBXHIJCPM.hAVGjyg6y2SepGUxBm9GG6SUEc06eQ2', 'Standard User', 'Supervisor', 'user', 'Active', NULL),
(101010, 'test@test.com', '$2y$10$w3jB2gBpDPD0pW0JTESMvOXZFNxnWF0FcyUWVNYN3dMxAPzb3R8T.', 'Test User', 'Skilled Laborer', 'user', 'Active', NULL),
(101012, 'jack@gmail.com', '$2y$10$AFRD6FC6W6PcjA/EBaByAeMQ3mWBOygEzrkPXrPEXNCryBHickzki', 'Jack Mencia', 'Other', 'user', 'Inactive', '2019-04-10');
...
--
ALTER TABLE `user_details`
  MODIFY `user_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101013;
COMMIT;
