...
--
-- Host: localhost
-- Generation Time: Apr 09, 2019 at 01:30 AM
...
-- Database: `cbsi_db`
--
CREATE DATABASE IF NOT EXISTS `cbsi_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cbsi_db`;
...
(404167, 202000, 11, 303001, '2019-04-07', 'false'),
...
--
ALTER TABLE `equipment_checkout`
  MODIFY `chk_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=404170;
...
('root', '[{\"db\":\"cbsi_db\",\"table\":\"equipment\"},{\"db\":\"cbsi_db\",\"table\":\"equipment_checkout\"},{\"db\":\"cbsi_db\",\"table\":\"user_details\"},{\"db\":\"cbsi_db\",\"table\":\"sites\"},{\"db\":\"testing2\",\"table\":\"product\"},{\"db\":\"cbsi_db\",\"table\":\"inventory_order\"},{\"db\":\"cbsi_db\",\"table\":\"product\"},{\"db\":\"testing2\",\"table\":\"user_details\"},{\"db\":\"testing2\",\"table\":\"inventory_order\"},{\"db\":\"testing2\",\"table\":\"inventory_order_product\"}]');
...
('root', '2019-04-08 23:27:11', '{\"Console\\/Mode\":\"collapse\",\"Server\\/hide_db\":\"\",\"Server\\/only_db\":\"\",\"NavigationWidth\":159}');
